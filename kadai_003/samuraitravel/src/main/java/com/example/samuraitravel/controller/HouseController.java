...
public class HouseController {
	...
	public HouseController(HouseRepository houseRepository, ReviewRepository reviewRepository, LikeRepository likeRepository) {
...
House house = houseRepository.getReferenceById(id);
		...
		if (userDetailsImpl != null) {
			...
			List<Like> like = likeRepository.findByHouseIdAndUserId(house.getId(), user.getId());
