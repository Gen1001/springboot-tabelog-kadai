...
public class AdminRestaurantController {
	...
	public String edit(@PathVariable(name = "id") Integer id, Model model) {
		...
		RestaurantEditForm restaurantEditForm = new RestaurantEditForm(restaurant.getId(), restaurant.getCategoryId(), restaurant.getName(), null, restaurant.getDescription(), restaurant.getPrice(), restaurant.getPostNumber(), restaurant.getAddress(), restaurant.getPhoneNumber(), restaurant.getOpenTime(), restaurant.getCloseTime(), restaurant.getCapacity(), restaurant.getHoliday(), restaurant.getKeyword());
		List<Category> category = categoryRepository.findAll();
